...
func NewPostCategoryService(categoryService service.CategoryService, db *gorm.DB) service.PostCategoryService {
...
func (p *postCategoryServiceImpl) ListCategoriesByPostID(ctx context.Context, postID int32) ([]*entity.Category, error) {
...
func (p *postCategoryServiceImpl) ListPostsByCategoryID(ctx context.Context, categoryID int32, status consts.PostStatus) ([]*entity.Post, error) {
	postCategoryDAL := dal.GetQueryByCtx(ctx).PostCategory
